...
Always check: README, in-repo docs (`docs/`, Docusaurus, mkdocs), `CLAUDE.md` / `AGENTS.md` if present, project rules if structure changed, and code comments that reference renamed symbols.
