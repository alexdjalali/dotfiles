...
- No issue-tracker ticket IDs (Linear/Jira/GitHub issue numbers) in comments or doc comments — they rot and couple code to an external tracker; keep that context in the commit/PR/tracker. Link only committed in-repo docs (under `docs/`), never gitignored or scratch paths
