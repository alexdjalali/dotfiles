    ...
    opts = function(_, opts)
      ...
      local function show_custom_cheatsheet()
        local lines = {
          ...
          "  AI Assistants",
          "  ─────────────",
          "  <leader>ac    Claude Toggle     Claude + shell (bottom split)",
          ...
          "  <leader>Ot    Codex Toggle      Open OpenAI Codex (float)",
          ...
          "  <leader>?c    AI Agents         All 6 AI tool keys",
      ...
      local function show_cursor_agent_cheatsheet()
        local lines = {
          ...
          "  ╰───────────────────────────────────────────────────────╯",
          "",
          "  <leader>ac    Toggle Claude     Claude + shell (bottom split)",
          "  <leader>ap    Pilot (alias)     Same as <leader>ac",
          ...
          "  ╰───────────────────────────────────────────────────────╯",
          "",
          "  <leader>Ot    Toggle            Float terminal (90x90%)",
          "  <leader>Oc    Open              Open Codex window",
          "",
          "  Inside Codex TUI:",
          "  /model          Switch model     GPT-5.3-Codex etc.",
          "  Ctrl-q          Quit             Close Codex window",
          "",
          "  ╭───────────────────────────────────────────────────────╮",
          "  │               Kilo AI (CLI)                           │",
          "  ╰───────────────────────────────────────────────────────╯",
          ...
          "  <leader>O   Codex         OpenAI terminal agent",
      ...
      local function show_spec_pipeline_cheatsheet()
        local lines = {
          ...
          "",
          "  Spec sub-phases (auto-chained by /spec):",
          "    spec-plan            Explore → design → write plan → approve",
          "    spec-implement       Delegates to /tdd per task",
          ...
          "  ╰───────────────────────────────────────────────────────╯",
          "",
          "  /tdd              TDD cycle (standalone or via spec-implement)",
          "                     → chains to: /github commit or /review",
          "  /github branch     Create feature branch (type/slug)",
          "  /github commit     Preflight + stage + conventional commit",
          "  /github pr         Push + create PR with template",
